...
extern long POSIX_pread(int *errnop, int fd, char *buf, size_t len, off_t offset);
extern long POSIX_pwrite(int *errnop, int fd, const char *buf, size_t len, off_t offset);
