...
static int
sslgen(Chan *c, char* _1, Dirtab *d, int nd, int s, Dir *dp)
{
	Qid q;
	Dstate *ds;
	char *p, *nm;
...
static Chan*
sslattach(Chan *c, Chan *ac, char *spec, int flags)
{
	c = devattach('D', spec);
...
static long
sslstat(Chan *c, uint8_t *db, long n)
{
...
static long
sslwstat(Chan *c, uint8_t *db, long n)
{
	Dir *dir;
	Dstate *s;
	int l;
 ...
 *  give back n bytes
static void
regurgitate(Dstate *s, uint8_t *p, int n)
{
	Block *b;
 ...
 */
static Block*
sslbread(Chan *c, long n, int64_t _1)
{
	Dstate * volatile s;
	Block *b;
...
static long
sslread(Chan *c, void *a, long n, int64_t off)
{
	Block * volatile b;
	Block *nb;
	uint8_t *va;
...
static long
sslbwrite(Chan *c, Block *b, int64_t _1)
{
	Dstate * volatile s;
	long rv;
...
static long
sslwrite(Chan *c, void *a, long n, int64_t _1)
{
	Dstate * volatile s;
	Block * volatile b;
	int l, t;
